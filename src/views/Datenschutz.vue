<template>
  <div class="m-20">
    <h1 class="mt-4">Datenschutzerklärung</h1>
    <h2 class="mt-4">Präambel</h2>
    <p>
    ...
    <h2 class="mt-4">Inhaltsübersicht</h2>
    <ul class="index">
    ...
    <h2 class="mt-4">Verantwortlicher</h2>
    <p>Anne Minkenberg<br />Oberbrucher Straße 2<br />52525 Heinsberg</p>
    E-Mail-Adresse:
    <p><a href="mailto:wearnize@gmail.com">wearnize@gmail.com</a></p>
    <h2 class="mt-4">Übersicht der Verarbeitungen</h2>
    <p>
    ...
    <h3 class="mt-4">Arten der verarbeiteten Daten</h3>
    <ul>
      <li>Kontaktdaten.</li>
      <li>Inhaltsdaten.</li>
      <li>Nutzungsdaten.</li>
    ...
    <h3 class="mt-4">Maßgebliche Rechtsgrundlagen</h3>
    <p>
    ...
    <h2 class="mt-4">Sicherheitsmaßnahmen</h2>
    <p>
    ...
    <h2 class="mt-4">Übermittlung von personenbezogenen Daten</h2>
    <p>
    ...
    <h2 class="mt-4">Datenverarbeitung in Drittländern</h2>
    <p>
    ...
    <p> </p>
    <h2 class="mt-4">Löschung von Daten</h2>
    <p>
    ...
    <h2 class="mt-4">Einsatz von Cookies</h2>
    <p>
    ...
    <h2 class="mt-4">Bereitstellung des Onlineangebotes und Webhosting</h2>
    <p>
    ...
    <h2 class="mt-4">Kontakt- und Anfragenverwaltung</h2>
    <p>
    ...
    <h2 class="mt-4">Änderung und Aktualisierung der Datenschutzerklärung</h2>
    <p>
    ...
    <h2 class="mt-4">Rechte der betroffenen Personen</h2>
    <p>
    ...
    <h2 class="mt-4">Begriffsdefinitionen</h2>
    <p>
