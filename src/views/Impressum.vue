<template>
  <div class="m-20">
    ...
    <h2 class="mt-4">Diensteanbieter</h2>
    <p>Anne Minkenberg</p>
    <p>Oberbrucher Straße 2</p>
    <p>52525 Heinsberg</p>
    <h2 class="mt-4">Kontaktmöglichkeiten</h2>
    E-Mail-Adresse:
    <p><a href="mailto:wearnize@gmail.com">wearnize@gmail.com</a></p>
    <h2 class="mt-4">Haftungs- und Schutzrechtshinweise</h2>
    <p>
    ...
    <p>
      ...
      Inhalte und Nachteile, die aus der Nutzung der in den verlinkten Webseiten
    ...
    <p>
      ...
      durch die jeweiligen Schutzrechte (Urheberrechte, Markenrechte) geschützt.
      Die Verwendung, Vervielfältigung usw. unterliegen unseren Rechten oder den
